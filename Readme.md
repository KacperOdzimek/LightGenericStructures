...
- LGS containers **take ownership** of objects **only on successful** add/push/insert operations.  
...
- LGS containers are valid even when **zero-initialized**.  
...
- If no allocator is provided, LGS defaults to the **stdlib heap allocator**.
